...
from conf import FAE_eval as config
    ...
    with torch.no_grad():
        ...
        for image, label in pbar:
            ...
            for my_tensor in split:
                ...
                anomaly_map = loss_fn(rec, feats).mean(1, keepdim=True)
